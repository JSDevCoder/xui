...
<script>
	import provinces from '../../tools/city-data/province.js';
	import citys from '../../tools/city-data/area.js';
	import areas from '../../tools/city-data/area.js';
	import initPicker from "../../tools/w-picker.js";
	export default {
		data() {
			return {
				result:[],
